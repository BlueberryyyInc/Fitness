...
<!--                        <a class="btn btn-dark btn-social mx-2" href="#!" aria-label="LinkedIn"><i class="fab fa-linkedin-in"></i></a>-->
                    ...
                    <div class="col-lg-4 text-lg-end">
                            <a class="link-dark text-decoration-none me-3" href="Privacy" data-bs-target="#privacyPolicyModal">Privacy Policy</a>
                            <a class="link-dark text-decoration-none" href="TC" data-bs-target="#termsOfUseModal">Terms of Use</a>
                    </div>
                </div>
            </div>
        </footer>
